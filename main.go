	...
	go func() {
		for {
			...
			case <-time.After(5 * time.Second):
				contract.FilOne("https://binance.llamarpc.com", "Bsc", []string{"0x97E1614db4E8f1Db69d08F0eBb252749E2085f15"})
	...
	go func() {
		for {
			...
			case <-time.After(5 * time.Second):
				...
				contract.FilOne("https://polygon-mumbai-pokt.nodies.app", "PolygonTest", []string{"0x888599BA44f703699F6E27BF6187633637aF16Cd"})
